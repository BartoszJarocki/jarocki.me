    ...
    <Layout>
      ...
      <Container>
        <article className="mb-32">
          ...
          >
            <div className="flex flex-col place-items-center m-5 sm:m-20 text-gray-700 hover:text-blue-400 cursor-pointer duration-200 ease-in-out">
              <svg
                className="h-10 w-10 m-6 transition-transform transform hover:-rotate-12"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
